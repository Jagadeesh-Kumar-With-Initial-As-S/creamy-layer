      ...
      <form action="" onSubmit={handleSubmit}>
        <div>
          <h1 className="heading">
            Where does your <span className="highlight">parent</span> belong to?
          </h1>
            ...
            <div className="container">
              <div className="group">
                <div className="text-container">
                  Parent<span className="highlight">currently working</span>in
                  <Box>
                    <FormControl>
                      ...
                      >
                        <MenuItem value={"option1"}>Government Sector</MenuItem>
